...
@REM QUARC Console - error/warning/status message monitoring
start "Drone_4_console" "%QUARC_DIR%\quarc_run" -c -t tcpip://192.168.2.%drone_4_id%:17000 *.rt-linux_x64
timeout /t 1

@REM QUARC Console - error/warning/status message monitoring
start "Drone_5_console" "%QUARC_DIR%\quarc_run" -c -t tcpip://192.168.2.%drone_5_id%:17000 *.rt-linux_x64
timeout /t 1

@REM QUARC Console - error/warning/status message monitoring
start "Drone_6_console" "%QUARC_DIR%\quarc_run" -c -t tcpip://192.168.2.%drone_6_id%:17000 *.rt-linux_x64
timeout /t 1
::----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
::Generic Timeout
...
@REM Drone 4 Model
start "drone_4_Commander_Stabilizer_Qdrone" "%QUARC_DIR%\quarc_run" -D -r -t tcpip://192.168.2.%drone_4_id%:17000 %QUARC_MODEL_NAME%.rt-linux_x64 -uri tcpip://192.168.2.%drone_4_id%:17001?retries=10 -URI_Host "tcpip://192.168.2.%pc_id%:%URI_Host_V4%"
timeout /t 1

@REM Drone 5 Model
start "drone_5_Commander_Stabilizer_Qdrone" "%QUARC_DIR%\quarc_run" -D -r -t tcpip://192.168.2.%drone_5_id%:17000 %QUARC_MODEL_NAME%.rt-linux_x64 -uri tcpip://192.168.2.%drone_5_id%:17001?retries=10 -URI_Host "tcpip://192.168.2.%pc_id%:%URI_Host_V5%"
timeout /t 1

@REM Drone 6 Model
start "drone_6_Commander_Stabilizer_Qdrone" "%QUARC_DIR%\quarc_run" -D -r -t tcpip://192.168.2.%drone_6_id%:17000 %QUARC_MODEL_NAME%.rt-linux_x64 -uri tcpip://192.168.2.%drone_6_id%:17001?retries=10 -URI_Host "tcpip://192.168.2.%pc_id%:%URI_Host_V6%"
timeout /t 1
