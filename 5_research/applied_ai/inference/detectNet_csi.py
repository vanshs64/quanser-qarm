...
# on the robot and runs it through a
# DetectNet to classify what appears on the image.

# -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
# imports
from pit.jetson.nets import DetectNet
...
# model
myModel=DetectNet(network = 'SSD-Mobilenet-v2',
