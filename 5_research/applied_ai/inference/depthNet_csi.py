...
# on the robot and runs it through a DepthNet 
# to identify the depth of objects that appear on the image.

# -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
# imports
from pit.jetson.nets import DepthNet
...
# model
myModel=DepthNet(network = 'fcn-mobilenet', # 'resnet18-hand'
