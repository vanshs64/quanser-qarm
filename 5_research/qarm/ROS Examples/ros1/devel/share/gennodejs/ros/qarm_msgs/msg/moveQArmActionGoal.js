...
class moveQArmActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = moveQArmGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += moveQArmGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new moveQArmActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = moveQArmGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new moveQArmGoal()
    }
...
module.exports = moveQArmActionGoal;
