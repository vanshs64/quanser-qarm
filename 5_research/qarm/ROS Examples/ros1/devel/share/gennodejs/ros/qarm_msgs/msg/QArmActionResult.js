...
class QArmActionResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new QArmActionResult(null);
  ...
  static datatype() {
    ...
    return 'qarm_msgs/QArmActionResult';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'fb74722661129100750a1a1badd64b15';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new QArmActionResult(null);
...
module.exports = QArmActionResult;
