...
class moveQArmActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new moveQArmFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = moveQArmFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new moveQArmActionFeedback(null);
    ...
    data.feedback = moveQArmFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += moveQArmFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new moveQArmActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = moveQArmFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new moveQArmFeedback()
    }
...
module.exports = moveQArmActionFeedback;
