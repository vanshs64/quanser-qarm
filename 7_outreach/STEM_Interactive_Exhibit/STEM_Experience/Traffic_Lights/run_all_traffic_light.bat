@REM Batch script to run the QUARC Server on the Traffic Light
...
for /l %%Q in (0, 1, 1) do (
    ...
    start "QUARC Server" "%QUARC_DIR%quarc_run" -r -t tcpip://!TRAFFIC_LIGHT_IP!:17000 !TRAFFIC_LIGHT_SERVER! -d /tmp -uri tcpip://!TRAFFIC_LIGHT_IP!:17001
    timeout /t 3
)