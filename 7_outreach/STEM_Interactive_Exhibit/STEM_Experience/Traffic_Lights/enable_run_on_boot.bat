...
for /l %%Q in (0, 1, 1) do (
    ...
    start "QUARC Server" "%QUARC_DIR%quarc_run" -B -t tcpip://!TRAFFIC_LIGHT_IP!:17000 !TRAFFIC_LIGHT_SERVER! -td %TRAFFIC_LIGHT_INITIAL_WAIT% -d /tmp -uri tcpip://!TRAFFIC_LIGHT_IP!:17001
    timeout /t 3
)